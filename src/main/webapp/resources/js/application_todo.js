...
$(function(){
  ...
  window.StoryView = Backbone.View.extend({
    ...
    // a one-to-one correspondence between a **Todo** and a **StoryView** in this
  ...
  window.AppView = Backbone.View.extend({
    ...
    render: function() {
      this.$('#todo-stats').html(this.statsTemplate({
        ...
        done:       Stories.done().length,
        remaining:  Stories.remaining().length
      }));
    },
    ...
    addOne: function(todo) {
      var view = new StoryView({model: todo});
    ...
    clearCompleted: function() {
      _.each(Stories.done(), function(todo){ todo.destroy(); });
      return false;
    },
